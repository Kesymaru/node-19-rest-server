...
(function (exports, URL) {
    ...
    const BASE_URL = window ? window.location.origin : 'http://test.com';
    let instance = null;
    ...
    exports.RoutePath = class RoutePath {
...
const ROUTES = [
    {
        path: 'students',
        method: 'POST',
        callback: () => console.log('POST students')
    },
    {
        path: 'students',
        method: 'GET',
        callback: (req, res, route) => console.log('GET students', req, res, route)
    },
    {
        path: 'students/create',
        callback: (route) => console.log('student create', route)
    },
    {
        path: 'students/:id',
        callback: () => console.log('students id')
    },
    {
        path: 'students/:id/grades/:gradeId',
        callback: (route) => console.log('students id grades', route)
    },
];